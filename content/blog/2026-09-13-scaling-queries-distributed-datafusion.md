...
<figure class="plan-figure">
  <img src="/diagrams/scaling-queries-distributed-datafusion/sales-partitions.svg" alt="products is a small unpartitioned dimension table. sales is a large fact table whose files sit on a timestamp by product_id grid." />
</figure>
...
<figure class="plan-figure">
  <img src="/diagrams/scaling-queries-distributed-datafusion/single-node-plan.svg" alt="Single-node DataFusion plan: sales scan, date_bin projection, sorted aggregate on product_id and bin, join to products, hash repartition, final aggregate on name and bin." />
</figure>
...
<figure class="plan-figure">
  <img src="/diagrams/scaling-queries-distributed-datafusion/distributed-plan.svg" alt="The same plan on two workers. Each worker reads products and a slice of sales. A network shuffle on name and bin feeds both final aggregates." />
</figure>
...
<figure class="plan-figure">
  <img src="/diagrams/scaling-queries-distributed-datafusion/speedup-vs-workers.svg" alt="Speedup versus worker count for 2-day, 30-day, and 60-day ranges. Longer ranges stay closer to the ideal linear line, reaching about 40x at 51 workers on the 60-day query." />
</figure>
